...
<CardGroup>
  ...
  <Card title="Runtime Memory" href="#advanced-features">
    Start here if you need Agent-style runtime memory and self-reference behavior.
  </Card>
...
- you want Agent-style tool calling and runtime memory
